...
export function HeroSearchTrigger() {
  ...
  return (
    <button
      onClick={open}
      className="flex w-full items-center gap-2.5 rounded-lg border border-border bg-bg px-4 py-3.5 text-left text-sm text-text-tertiary shadow-lg shadow-black/5 transition-colors hover:border-border-hover"
    >
