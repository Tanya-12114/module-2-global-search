...
export function SearchDropdown({
  ...
  return (
    <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-30 max-h-[420px] overflow-y-auto rounded-lg border border-border bg-surface shadow-2xl shadow-black/40">
      {showSuggestions ? (
        <SuggestionList
          isLoading={isLoading}
